...
@interface ABI33_0_0AIRGoogleMap : GMSMapView
...
@property (nonatomic, copy) ABI33_0_0RCTBubblingEventBlock onKmlReady;
...
@property (nonatomic, copy) ABI33_0_0RCTBubblingEventBlock onUserLocationChange;
@property (nonatomic, copy) ABI33_0_0RCTBubblingEventBlock onMarkerPress;
@property (nonatomic, copy) ABI33_0_0RCTBubblingEventBlock onChange;
@property (nonatomic, copy) ABI33_0_0RCTBubblingEventBlock onPoiClick;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onRegionChange;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onRegionChangeComplete;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onIndoorLevelActivated;
@property (nonatomic, copy) ABI33_0_0RCTDirectEventBlock onIndoorBuildingFocused;
